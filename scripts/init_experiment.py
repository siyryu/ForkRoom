...
try:
    from scripts.record_session import RecordSessionError, record_session
except ModuleNotFoundError:  # pragma: no cover - used when executed as scripts/init_experiment.py
...
def final_validation(
    *,
    ...
    checks = {
        ...
        "worktree_registered": worktree_registered(root, worktree_path),
